...
**Дата документа**: 19 декабря 2025 г.
...
DMarket API использует HMAC-SHA256 для подписи запросов.
...
**Примечание**: Документация актуальна на 19 декабря 2025 г. Всегда проверяйте официальную документацию DMarket для получения последних обновлений.
