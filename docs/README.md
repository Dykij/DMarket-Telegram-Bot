...
- **[Обработка ошибок](ERROR_HANDLING_GUIDE.md)** - Логирование и обработка ошибок
- **[Кэширование](CACHING_GUIDE.md)** - Система кэширования
- **[Контрактное тестирование](CONTRACT_TESTING.md)** - Pact-тесты для API
- **[Dependency Injection](DEPENDENCY_INJECTION.md)** - Паттерн внедрения зависимостей
- **[Структуры данных](DATA_STRUCTURES_GUIDE.md)** - Основные структуры данных проекта
