...
- **[AI Tools Guide](AI_TOOLS_GUIDE.md)** - Использование GitHub Copilot и AI-инструментов
- **[AnyTool & n8n Integration](ANYTOOL_N8N_INTEGRATION_GUIDE.md)** - 🆕 Universal Tool-Use Layer для AI агентов:
  - Smart Tool RAG для автоматического выбора инструментов
  - Visual workflow automation с n8n
