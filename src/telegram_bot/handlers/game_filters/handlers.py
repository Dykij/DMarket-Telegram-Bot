...
async def handle_set_category_callback(
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:category:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_rarity_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:rarity:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_exterior_callback(
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:exterior:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_hero_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:hero:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_slot_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:slot:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_class_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:class:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_type_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:type:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
...
async def handle_set_quality_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard.extend(([InlineKeyboardButton("Сбросить", callback_data=f"filter:quality:reset:{game}")], [InlineKeyboardButton("⬅️ Назад", callback_data=f"select_game_filter:{game}")]))
