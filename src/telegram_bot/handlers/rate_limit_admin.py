...
async def rate_limit_stats_command(
    ...
    try:
        ...
        logger.exception("rate_limit_stats_error", error=str(e), user_id=user_id)
...
async def rate_limit_reset_command(
    ...
    try:
        ...
        logger.exception("rate_limit_reset_error", error=str(e), user_id=user_id)
...
async def rate_limit_whitelist_command(
    ...
    try:
        ...
        logger.exception("rate_limit_whitelist_error", error=str(e), user_id=user_id)
...
async def rate_limit_config_command(
    ...
    try:
        ...
        logger.exception("rate_limit_config_error", error=str(e), action=action)
