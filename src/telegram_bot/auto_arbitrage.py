    ...
    try:
            ...
            if balance_result.get("error", False):
                ...
                if (
                    ...
                    error_text = (
                        ...
                        "функциям DMarket (баланс, инвентарь, торговля).\n\n"
        ...
        if "404" in error_message or "not found" in error_message.lower():
            error_text = (
                ...
                "Ваши API ключи действительны, но не имеют доступа к приватным "
                "функциям DMarket (баланс, инвентарь, торговля).\n\n"
...
async def handle_auto_trade(query, context, mode: str) -> None:
