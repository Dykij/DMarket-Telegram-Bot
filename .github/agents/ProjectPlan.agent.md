...
|---------|----------|--------|
| **Прогресс** | 44% (22/50) | Активная разработка |
| **Тесты** | 2688/2688 ✅ | 100% проходят |
| **Покрытие** | 85%+ (цель) | Текущий фокус |
| **Python** | 3.11+ | 3.12+ рекомендуется |
| **Кодовая база** | ~25K строк | 227 Python файлов |
| **Тестовая база** | 115 файлов | Unit + Integration + Contracts + Property-based |
...
tests/                   # 🧪 Testing (115 файлов, 2688 тестов)
