...
| ------------------------------------- | --------- | ------------------------ |
| `src/mcp_server/__init__.py`          | 🔴 HIGH    | MCP Server инициализация |
| `src/mcp_server/dmarket_mcp.py`       | 🔴 HIGH    | DMarket MCP Server       |
| `src/cli/copilot_cli.py`              | 🔴 HIGH    | CLI интерфейс            |
| `src/cli/pipe_handler.py`             | 🔴 HIGH    | Unix pipe handler        |
| `src/copilot_sdk/autonomous_agent.py` | 🔴 HIGH    | Автономный агент         |
| `src/copilot_sdk/file_editor.py`      | 🟡 MED     | Редактор файлов          |
| `src/copilot_sdk/project_indexer.py`  | 🟡 MED     | Индексатор проекта       |
| `.github/workflows/copilot-agent.yml` | 🟡 MED     | CI/CD агент              |
...
- [ ] Создать MCP Server для DMarket
- [ ] Реализовать CLI интерфейс
- [ ] Добавить pipe handling

### Неделя 2: Autonomous Agent
- [ ] Реализовать autonomous_agent.py
- [ ] Добавить file_editor.py
- [ ] Создать project_indexer.py
