...
class TestTaskType:
    ...
    def test_all_task_types_exist(self):
        ...
        assert hasattr(TaskType, "MODEL_TRAINING")
    ...
    def test_task_type_values(self):
        ...
        assert TaskType.MODEL_TRAINING.value == "model_training"
...
class TestMLDataScheduler:
    ...
    def test_schedule_multiple_tasks(self, scheduler):
        ...
        scheduler.schedule_task(TaskType.DATA_COLLECTION)
        scheduler.schedule_task(TaskType.MODEL_TRAINING)
...
class TestMLDataSchedulerErrorHandling:
    ...
    def scheduler_with_errors(self):
        ...
        mock_predictor = MagicMock()
        mock_predictor.train_from_real_data = AsyncMock(side_effect=Exception("Training Error"))
