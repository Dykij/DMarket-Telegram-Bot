...
def test_connection_pool_limits_configured(api_client):
    ...
    assert limits.max_keepalive_connections == 30  # Updated to match actual default
    assert limits.keepalive_expiry == 60.0  # Updated: implementation uses 60.0
...
async def test_get_connection_pool_stats_when_active(api_client):
    ...
    assert stats["max_keepalive"] == 30  # Updated to match actual default
    assert stats["keepalive_expiry"] == 60.0  # Updated: implementation uses 60.0
