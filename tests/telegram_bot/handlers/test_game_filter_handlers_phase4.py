...
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, Update, User, CallbackQuery
...
class TestGetCurrentFilters:
    ...
    def test_get_current_filters_empty_context(self, mock_context):
        ...
        from src.telegram_bot.handlers.game_filter_handlers import get_current_filters, DEFAULT_FILTERS
...
class TestUpdateFilters:
    ...
    def test_update_filters_basic(self, mock_context):
        ...
        from src.telegram_bot.handlers.game_filter_handlers import update_filters, get_current_filters
...
class TestHandleSelectGameFilterCallback:
    ...
    async def test_select_csgo_filter(self, mock_update, mock_context):
        ...
        from src.telegram_bot.handlers.game_filter_handlers import handle_select_game_filter_callback
...
class TestHandleFilterCallback:
    ...
    async def test_filter_callback_reset_all(self, mock_update, mock_context):
        ...
        from src.telegram_bot.handlers.game_filter_handlers import handle_filter_callback, DEFAULT_FILTERS
...
class TestEdgeCases:
    ...
    def test_get_filters_multiple_games(self, mock_context):
        ...
        from src.telegram_bot.handlers.game_filter_handlers import (
            get_current_filters, update_filters
        )
