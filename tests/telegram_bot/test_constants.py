...
class TestPathConstants:
    ...
    def test_user_profiles_file_exists(self):
        ...
        from src.telegram_bot.constants import USER_PROFILES_FILE, DATA_DIR
...
class TestLanguages:
    ...
    def test_languages_values_contain_emoji(self):
        ...
        for lang_code, display_name in LANGUAGES.items():
...
class TestConstantsIntegration:
    ...
    def test_notification_types_and_priorities_consistency(self):
        ...
        from src.telegram_bot.constants import NOTIFICATION_TYPES, NOTIFICATION_PRIORITIES
