...
- **[Интеграция в курс Deep Learning](docs/DEEP_LEARNING_COURSE_INTEGRATION.md)** 🆕⭐ - Как использовать бот для обучения PyTorch и deep learning:
  - 7 способов применения в курсе
  - Практические задания по неделям
  - Production ML infrastructure
  - Шаблоны проектов для студентов
- **[Учебные материалы](educational_materials/README.md)** 🆕 - Готовые материалы для студентов курса deep_learning_pytorch:
  - Быстрый старт
  - Задания по неделям
  - Шаблоны кода
  - FAQ для студентов
