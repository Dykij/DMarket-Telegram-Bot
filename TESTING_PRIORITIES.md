...
| **market_analysis_handler.py** | `src/telegram_bot/handlers/market_analysis_handler.py` | 1121 | ~45% | 80+ | 🔥 ВЫСОКИЙ | 📋 Следующий |
